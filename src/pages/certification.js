...
const columns = [
    { id: 'name', label: 'Certification Name', minWidth: 10 },
    { id: 'code', label: 'Issuing Organization', minWidth: 10 },
    {
      id: 'population',
      label: 'Issued date',
      minWidth: 10,
...
const [endDate, setEndDate] = useState(new Date());
  ...
  const [uploadCertification, setUploadCertification] = React.useState();
  // dialog
  ...
  return (<>
    <div className='education' stle={{paddinBottom:'20px'}}>
      <div class="row" style={{padding:'10px'}}>
        <div class="col-lg-10 col-12" ><h5>My Certification</h5></div>
    ...
    <div  class="row">
        <div class="col-10"><DialogTitle >Add Experience Details</DialogTitle></div>
        ...
        <div class="col-md-6 col-sm-12 col-12">
                <p>Certification Name<span style={{color:"red"}}>*</span></p>
            <input type="text" class="form-control" placeholder="Enter CertificationName"
            // value={university} onChange={(e) => setUniversity(e.target.value)}
           
            />
            </div>
            <div class="col-md-6 col-sm-12 col-12">
                <p>Issuing Irganization<span style={{color:"red"}}>*</span></p>
            <input type="text" class="form-control" placeholder="Enter Designatiopn"
        ...
        <div class="col-md-6 col-sm-12 col-12">
                <p>Credential Id</p>
            <input type="text" class="form-control" placeholder="Enter Credential Id"
            // value={university} onChange={(e) => setUniversity(e.target.value)}
            ...
            <div class="col-md-6 col-sm-12 col-12">
                <p>Credential URL</p>
            <input type="text" class="form-control" placeholder="Enter Credential URL"
            // value={specialization} onChange={(e) => setSpecialization(e.target.value)}
            />
            </div>
        </div>
       ...
       <div class="row">
        <div class="col-md-6 col-sm-12 col-12">
              <p>Certication</p>
            <input type="file"
             onChange={(e) => setUploadCertification(e.target.files)} />
