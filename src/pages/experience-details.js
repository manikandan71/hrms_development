...
const columns = [
    ...
    { id: 'code', label: 'Designation', minWidth: 10 },
    {
      id: 'population',
      label: 'Start Date',
      minWidth: 10,
...
const [endDate, setEndDate] = useState(new Date());
  ...
  const [uploadOfferLetter, setUploadOfferLetter] = React.useState(); 
  const [uploadLeavingLetter, setUploadLeavingLetter] = React.useState(); 
  const [uploadSalarySlip, setUploadSalarySlip] = React.useState(); 
  ...
  return (<>
    <div className='education'>
      <div class="row" style={{padding:'10px'}}>
        <div class="col-lg-10 col-12" ><h5>My Experience Details</h5></div>
    ...
    <div  class="row">
        ...
        <div class="col-md-6 col-sm-12 col-12">
                <p>Company Name</p>
            <input type="text" class="form-control" placeholder="Enter conpany Name"
        ...
        <div class="col-md-6 col-sm-12 col-12">
            ...
            <input type="file" style={{width: "90%"}}
             onChange={(e) => setUploadOfferLetter(e.target.files)} />
       
            </div>
            <div class="col-md-6 col-sm-12 col-12">
              <p>Leaving Letter</p>
            <input type="file" style={{width: "90%"}}
             onChange={(e) => setUploadLeavingLetter(e.target.files)} />
        ...
        <div class="col-md-6 col-sm-12 col-12">
              <p>Salary Slip</p>
            <input type="file" multiple style={{width: "90%"}}
             onChange={(e) => setUploadSalarySlip(e.target.files)} />
